...
/**
 * {createStream} options object type
 */
export interface ICreatStreamOptions {
    audio: boolean;
    minWidth: number;
    maxWidth: number;
    minHeight: number;
 ...
 */
export const createStream = (source: DesktopCapturerSource, opts?: ICreatStreamOptions) => {
    return navigator.mediaDevices.getUserMedia({
        audio: (opts || {} as any).audio || false,
        video: {
          mandatory: {
              ...opts,
